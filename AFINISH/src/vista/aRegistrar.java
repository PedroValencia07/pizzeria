...
public class aRegistrar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cbRol.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Cliente", "Empleado", "Administrador", "Master Admin" }));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        int r;
        String btnN, btnNT, btnP, btnD1, btnR1;
        ...
        if ( r < 0 || btnN.isEmpty() || btnNT.isEmpty() || contra.isEmpty() || btnD1.isEmpty() || btnR1.isEmpty() ) {
            ...
            if (u.rol == 0 ) {
                ...
                u.register(r, btnN, btnNT, contra, btnD1, "", "", btnR1, "", "");
